...
impl TryFrom<management::DatabaseRules> for DatabaseRules {
    ...
    fn try_from(proto: management::DatabaseRules) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::MutableBufferConfig> for MutableBufferConfig {
    ...
    fn try_from(proto: management::MutableBufferConfig) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::Order> for Order {
    ...
    fn try_from(proto: management::Order) -> Result<Self, FieldViolation> {
        Ok(match proto {
...
impl TryFrom<management::ColumnType> for ColumnType {
    ...
    fn try_from(proto: management::ColumnType) -> Result<Self, FieldViolation> {
        Ok(match proto {
...
impl TryFrom<management::Aggregate> for ColumnValue {
    ...
    fn try_from(proto: management::Aggregate) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::WalBufferConfig> for WalBufferConfig {
    ...
    fn try_from(proto: management::WalBufferConfig) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::wal_buffer_config::Rollover> for WalBufferRollover {
    ...
    fn try_from(proto: management::wal_buffer_config::Rollover) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::PartitionTemplate> for PartitionTemplate {
    ...
    fn try_from(proto: management::PartitionTemplate) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::partition_template::part::Part> for TemplatePart {
    ...
    fn try_from(proto: management::partition_template::part::Part) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::partition_template::Part> for TemplatePart {
    ...
    fn try_from(proto: management::partition_template::Part) -> Result<Self, FieldViolation> {
...
impl TryFrom<management::subscription_config::Subscription> for Subscription {
    ...
    fn try_from(
        proto: management::subscription_config::Subscription,
    ) -> Result<Self, FieldViolation> {
        Ok(Self {
...
impl TryFrom<management::Matcher> for Matcher {
    ...
    fn try_from(proto: management::Matcher) -> Result<Self, FieldViolation> {
        Ok(Self {
...
impl TryFrom<management::matcher::TableMatcher> for MatchTables {
    ...
    fn try_from(proto: management::matcher::TableMatcher) -> Result<Self, FieldViolation> {
...
mod tests {
    ...
    fn mutable_buffer_config() {
        ...
        assert_eq!(config.buffer_size, protobuf.buffer_size);
        assert_eq!(
